    ...
    <div class="sidebar">
        <div>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a href="myOrders" class="nav-link">Đơn của tôi</a></li>
                <li class="nav-item"><a href="orderStats" class="nav-link">Bảng thống kê đơn</a></li>
                <li class="nav-item"><a href="manageOrders" class="nav-link">Quản lý đơn</a></li>
                <li class="nav-item"><a href="dataTable" class="nav-link">Bảng dữ liệu</a></li>
            </ul>
        </div>

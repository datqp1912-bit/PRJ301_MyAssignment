...
<head>
    ...
    <style>
        ...
        .sidebar { width: 250px; background-color: #1e293b; color: white; display: flex; flex-direction: column; justify-content: space-between; padding: 20px; position: fixed; top: 0; left: 0; bottom: 0; }
        .sidebar h5 { margin-bottom: 20px; color: #f8fafc; }
        .sidebar .nav-link { color: white; padding: 10px 0; text-decoration: none; display: block; }
        .sidebar .nav-link:hover { background-color: rgba(255, 255, 255, 0.2); border-radius: 5px; }
        .logout-btn { margin-top: 20px; }
        .main-content { margin-left: 250px; flex: 1; background-color: #f8f9fa; padding: 30px; height: 100vh; overflow-y: auto; }
        .form-container { max-width: 650px; margin: auto; background: white; padding: 25px 30px; border-radius: 10px; box-shadow: 0 0 8px rgba(0,0,0,0.1); }
        .form-container h3 { text-align: center; margin-bottom: 25px; }
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <!-- **Action trỏ đúng servlet tạo đơn** -->
            <form action="UserCreateApplicationServlet" method="post">
                <div class="mb-3">
